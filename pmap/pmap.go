/*
  pmap.go.  Parallel directoy mapping.
...
func main() {
	fmt.Println("Parallel directory mapping.  LastAltered", LastAlteredDate)
	...
	fmt.Println()
	fmt.Println(" pmap sums the directories it walks using multithreaded code.  Written in Go.  Last altered ", LastAlteredDate)
