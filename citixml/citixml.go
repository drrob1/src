...
type citixmlheadertype struct {
	...
	ORG      string `xml:"ORG,chardata,OFX>SIGNONMSGSRSVR1>SONRS>FI" `
	FID      int    `xml:"FID,any,attr,OFX>SIGNONMSGSRSVR1>SONRS>FI" `
	CURDEF   string `xml:"CURDEF,chardata,OFX>BANKMSGSRSV1>STMTTRNRS"`
	BANKID   string `xml:"BANKID,chardata,OFX>BANKMSGSRSV1>STMTTRNRS>BANKACCTFROM"`
	ACCTID   string `xml:"ACCTID,chardata,OFX>BANKMSGSRSV1>STMTTRNRS>BANKACCTFROM"`
	ACCTTYPE string `xml:"ACCTTYPE,chardata,OFX>BANKMSGSRSV1>STMTTRNRS>BANKACCTFROM"`
	DTSTART  string `xml:"DTSTART,chardata,OFX>BANKMSGSRSV1>STMTTRNRS>BANKTRANLIST"`
	DTEND    string `xml:"DTEND,chardata,OFX>BANKMSGSRSV1>STMTTRNRS>BANKTRANLIST"`
}
