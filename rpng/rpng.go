...
import (
	...
	"makesubst"
	"tokenize"
	// "timlibg"  Not needed now that DOW is fully processed in hpcalc
	// "holidaycalc"  Supplanted by stringslice
)

const LastAlteredDate = "18 July 17"
...
func main() {
	...
	*/
	...
	ClearScreen()
	fmt.Println(" StorageFullFilename (1,2,3):", StorageFullFilename, Storage2FullFilename, Storage3FullFilename)
	fmt.Println()
	//  fmt.Println();
	...
	fmt.Println(" HP-type RPN calculator written in Go.  Last altered ", LastAlteredDate)
	fmt.Println()
