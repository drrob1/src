// rex2.go -- directory sort using a regular expression pattern
...
25 Jul 21 -- Now called rex2.go, as reg conflicted on Windows w/ a registry edit pgm.
...
func main() {
	...
	var nscreens = flag.Int("n", 1, "number of lines to display") // Ptr
	var NLines int
