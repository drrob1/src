...
/*
I decided to follow the Hands On GUI book for code, which is different than the other versions now.  It works differently, but still not what I want.
And I deided to name it basicmenu5.go.  I reverted basicmenu4.go by using the "git checkout basicmenu4.go" command.
...
func main() {
	...
	//window.Layout().SetAlignment(toolbar, core.Qt__AlignBottom)  Doesn't do what I want, anyway.
