...
I'll remove the menubar and just have the toolbar.
...
func main() {
	...
	//a.ConnectTriggered(func(checked bool) { filenewmenuoption() return })  // function to execute when option is triggered
	...
	//b.ConnectTriggered(func(checked bool) { fileopenmenuoption() return 	}) // function to execute when option is triggered
	...
	//e.ConnectTriggered(func(checked bool) { 	fileclosemenuoption() 	return 	})
	...
	//d.ConnectTriggered(func(checked bool) { 	filehelpmenuoption() 	return 	})
	...
	//f.ConnectTriggered(func(checked bool) { 	fileaboutmenuoption()	return})
	...
	//c.ConnectTriggered(func(checked bool) {	filequitmenuoption()	return})
