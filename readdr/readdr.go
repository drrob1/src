// readdr.go -- Derived from dsrt.go directory sort
...
func main() {
	...
	ctfmt.Print(ct.Magenta, winflag, "readdr lastAltered ", LastAltered, ", compiled using ", runtime.Version(), ".")
	fmt.Println()
