...
21 Jul 21 -- Now called regx3.go, because reg is a windows registry editor, and for 3 column output.
             Shows the filesizes in a more compressed format.  It will set "w" to be 2/3's of dsw environ var.
             And use a file timestamp only including the date and not the time.
*/
...
//	var userptr *user.User // from os/user
	...
	// Output the colorStringSlice, 3 items per line, but I want the sort to remain vertical
