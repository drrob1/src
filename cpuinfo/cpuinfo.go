...
func main() {
	...
	if goarch == "amd64" {
		fmt.Printf(" HasAES = %t, HasADX add carry extension = %t, HasAVX512 advanced vector extension = %t, HasCX16 compare and exchange 16 bytes = %t \n",
			cpu.X86.HasAES, cpu.X86.HasADX, cpu.X86.HasAVX512, cpu.X86.HasCX16)
