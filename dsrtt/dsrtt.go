// dsrtt.go -- directory sort using old case insensitive matching code.
...
10 Mar 21 -- Made this now dsrtt.go, to preserve the old case insensitive match code.
12 Mar 21 -- Added os.Exit for the file not found condition on linux.
*/
...
func main() {
	...
	ctfmt.Print(ct.Magenta, winflag, "dsrtt will display Directory SoRTed by date or size.  LastAltered ", LastAltered, ", compiled using ",
		runtime.Version(), ".")
	fmt.Println()
