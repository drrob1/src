...
func main() {
	...
	str := fmt.Sprintf("Image Viewer 3 last modified %s, compiled using %s", LastModified, runtime.Version())
	if *verboseFlag {
...
func keyTyped(e *fyne.KeyEvent) { // index and shiftState are global var's
	...
	case fyne.KeyR:
		//atomic.AddInt64(&rotatedCtr, 1) no need for atomic operations
		rotatedCtr++
