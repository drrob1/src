package main // fsha.go from fansha.go from csha.go from consha.go
...
------------------------------------------------------------------------------------------------------------------------------------------------------
   7 May 26 -- Now called fsha; it's about time as I've been calling it fsha for ~2 yrs.
*/

const LastCompiled = "7 May 2026"
