...
func main() {
	...
	// input := widgets.NewQLineEdit(nil)  //  func NewQLineEdit(parent QWidget_ITF) *QLineEdit or func NewQLineEdit2(contents string, parent QWidget_ITF) *QLineEdit
	input := widgets.NewQLineEdit(mainWidget)
