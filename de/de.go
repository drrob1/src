...
func main() {
	...
	if err != nil {                                                // this may be triggered if I redirect output, so os.Stdout is not the screen.
		//autoDefaults = false
	...
	if veryVerboseFlag { // very verbose flag will also turn on verbose flag, ie, testFlag
		testFlag = true
	}
